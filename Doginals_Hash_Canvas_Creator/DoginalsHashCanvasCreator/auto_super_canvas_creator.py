...
def render_image(transaction_id, hidden_message):
    ...
    hash_as_int = int.from_bytes(hashlib.sha256(transaction_id.encode()).digest(), byteorder='big')
    ...
    image_path = f"super-canvas_generated_images/{transaction_id}_steg.png"

    # Encode both the transaction ID and the hidden message and hide them
