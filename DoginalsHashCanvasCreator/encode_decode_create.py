...
class YourApp(QMainWindow):
    ...
    def initUI(self):
        ...
        self.inputImagePathDecoder.setPlaceholderText("Enter image path for Decoder to Decode....PLEASE BE PATIENT THIS FUNCTION TAKES approx. 69s")
    ...
    def runHashMapGenerator(self):
        transaction_ids_input = self.inputTransactionIDsHashMap.text()
        hidden_messages_input = self.inputHiddenMessagesHashMap.text()
        ...
        # Run subprocess for hash map generator
    ...
    def runSuperCanvasGenerator(self):
        transaction_ids_input = self.inputTransactionIDsSuperCanvas.text()
        hidden_messages_input = self.inputHiddenMessagesSuperCanvas.text()
        ...
        # Run subprocess for super canvas generator
