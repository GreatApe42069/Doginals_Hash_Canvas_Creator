...
class YourApp(QMainWindow):
    ...
    def initUI(self):
        ...
        self.inputImagePathEncoder.setPlaceholderText("Enter image path or paths for Encoding")
        ...
        self.inputHiddenMessageEncoder.setPlaceholderText("Enter hidden message or messages for Encoding")
        ...
        self.inputTransactionIDsColorBlock.setPlaceholderText("Enter transaction ID or IDs separated by a space or comma")
        ...
        self.inputHiddenMessagesColorBlock.setPlaceholderText("Enter hidden message or messages separated by a space or comma")
        ...
        self.inputTransactionIDsHashMap.setPlaceholderText("Enter transaction ID or IDs separated by a space or comma")
        ...
        self.inputHiddenMessagesHashMap.setPlaceholderText("Enter hidden message or messages separated by a space or comma")
        ...
        self.inputTransactionIDsSuperCanvas.setPlaceholderText("Enter transaction ID or IDs separated by a space or comma")
        ...
        self.inputHiddenMessagesSuperCanvas.setPlaceholderText("Enter hidden message or messages separated by a space or comma")
    ...
    def runColorBlockGenerator(self):
        ...
        hidden_messages = self.inputHiddenMessagesColorBlock.text()  # Get hidden messages from the input field
        if not hidden_messages:
            QMessageBox.warning(self, "Warning", "Please enter hidden messages for Color Block Generator.")
            return

        # Split the input transaction IDs and hidden messages and create a list of dictionaries
        transaction_list = [{"TransactionID": tid, "HiddenMessage": msg} for tid, msg in zip(transaction_ids.split(), hidden_messages.split())]

        # Save transaction IDs and hidden messages in JSON format
    ...
    def runHashMapGenerator(self):
        ...
        hidden_messages = self.inputHiddenMessagesHashMap.text()  # Get hidden messages from the input field
        if not hidden_messages:
            QMessageBox.warning(self, "Warning", "Please enter hidden messages for Hash-map Generator.")
            return
    ...
    def runSuperCanvasGenerator(self):
        ...
        hidden_messages = self.inputHiddenMessagesSuperCanvas.text()  # Get hidden messages from the input field
        if not hidden_messages:
            QMessageBox.warning(self, "Warning", "Please enter hidden messages for Super Canvas Generator.")
            return
